...
class MyDocument extends Document {
  ...
  render() {
    return (
      <Html>
        <Head>
          <meta name="application-name" content="Food Divider App" />
          <meta name="apple-mobile-web-app-capable" content="yes" />
          <meta
            name="apple-mobile-web-app-status-bar-style"
            content="default"
          />
          <meta name="apple-mobile-web-app-title" content="Food Divider App" />
          <meta name="description" content="หารค่าอาหาร" />
